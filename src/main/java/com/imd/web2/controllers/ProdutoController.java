...
public class ProdutoController {
    ...
    @PutMapping("{id}")
    public ResponseEntity<Object> updateProduto(@PathVariable Long id, @RequestBody ProdutoDTO produtoDTO) {
        var produto = produtoService.updateProduto(id, produtoDTO);
        if (produto == null) {
